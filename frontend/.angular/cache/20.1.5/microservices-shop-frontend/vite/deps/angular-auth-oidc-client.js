import {
  Router
} from "./chunk-ZSV5L3DO.js";
import "./chunk-R4NNTIQ6.js";
import {
  HttpClient,
  HttpErrorResponse,
  HttpHeaders,
...
} from "./chunk-ZY2AJNKB.js";
import {
  CommonModule,
  isPlatformBrowser
} from "./chunk-GILHRL2F.js";
...
var getFrameId = (configId) => `${IFRAME_FOR_SILENT_RENEW_IDENTIFIER}_${configId}`;
...
var _RefreshSessionService = class _RefreshSessionService {
  ...
  forceRefreshSession(config, allConfigs, extraCustomParams) {
    ...
    return forkJoin([this.startRefreshSession(config, allConfigs, extraCustomParams), this.silentRenewService.refreshSessionWithIFrameCompleted$.pipe(filter((result) => result?.configId === config.configId), take(1))]).pipe(timeout(timeOutTime), retryWhen((errors) => {
...
var _ClosestMatchingRouteService = class _ClosestMatchingRouteService {
  ...
  routeMatches(configuredRoute, route) {
    return route.startsWith(configuredRoute) || this.matchesRoute(configuredRoute, route);
  }
